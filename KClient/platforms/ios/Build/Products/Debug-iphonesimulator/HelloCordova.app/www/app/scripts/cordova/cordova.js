; (function () {
    window.cordovaCustomPlugin = {
        ...
        isSupportAndroidPlatform: function () {
            if (!(this.isKClient && this.isAndroid)) return false;
            return true;
        },
        isSupportIosPlatform: function () {
            if (!(this.isKClient && this.isIos)) return false;
            return true;
        },
        isHasPlatformSupport: function () {
            //var flagAndroid = this.isSupportAndroidPlatform();
            //var flagIos = this.isSupportAndroidPlatform();
            //if (!(flagAndroid | flagIos)) return false;
            //return true;
			if(!this.isKClient)return false;
			if(!(this.isAndroid||this.isIos)) return false;
			return true;
        }
    };
    window.cordovaCustomPlugin.init();
    //load cordova.ios.js || cordova.ios.js
    if (window.cordovaCustomPlugin.isSupportAndroidPlatform()) {
            ; (function () {
    ...
    } else if (window.cordovaCustomPlugin.isSupportIosPlatform()) {
            ; (function () {
                var CORDOVA_JS_BUILD_LABEL = '2.9.1';
                // file: lib/scripts/require.js
